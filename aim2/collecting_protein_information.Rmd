...
signals_only <- filter(reordered_unique_protein_table, SignalP == "Y")

signals_na <- filter(reordered_unique_protein_table, is.na(SignalP))

high_cysteines <- filter(reordered_unique_protein_table, max_cysteine_count >= 6)
```
