...
TD_psg_row_order <- hclust(dist(TD_psg_matrix_for_clust))$order
TD_psg_col_order <- hclust(dist(t(TD_psg_matrix_for_clust)))$order
...
TD_psg_matrix_clean_ids_hm <- Heatmap(TD_psg_matrix_clean_ids[,-c(13:15)], 
                                      ...
                                      column_order = TD_psg_col_order[-c(1,2,15)])
